...
class INA226_WE
{
    public:
        ...
        // Constructors: if not passed, 0x41 / Wire will be set as address / wire object
        INA226_WE(const int addr = 0x41) : _wire{&Wire}, i2cAddress{addr} {}
        INA226_WE(TwoWire *w, const int addr = 0x41) : _wire{w}, i2cAddress{addr} {}
