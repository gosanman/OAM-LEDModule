...
../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_LEDDK_06_V10 LEDDK_06_V10 uf2
 if (!$?) { exit 1 }

../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_LEDDK_12_V10 LEDDK_12_V10 uf2
 if (!$?) { exit 1 }

../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_LEDDK_06_V12 LEDDK_06_V12 uf2
 if (!$?) { exit 1 }

../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_LEDDK_12_V12 LEDDK_12_V12 uf2
 if (!$?) { exit 1 }

../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_LEDAPP_06_V01 LEDAPP_06_V01 uf2
 if (!$?) { exit 1 }
